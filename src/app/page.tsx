    ...
    <div className='min-h-dvh flex flex-col justify-center gap-16'>
      <div className='flex flex-col gap-8 items-center md:items-start'>
        ...
        <h1 className='text-4xl text-center leading-none font-heading font-medium flex flex-col md:text-7xl md:text-left'>
          <span className='text-blue'>CodeCraft</span>Summit 2025</h1>
      </div>
      <div className='flex gap-5 items-stretch flex-col md:flex-row'>
        <div className='flex-1 bg-gray-700 border-gray-600 rounded-2xl p-8 space-y-6'>
          <div className='flex items-center justify-between'>
            ...
            <span className='text-purple font-semibold text-xs flex items-center gap-2'><Radio className='size-5' /> AO VIVO</span>
          </div>
